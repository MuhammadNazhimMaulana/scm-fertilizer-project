    ...
    <div class="row justify-content-center h-100">
        <div class="card w-50 my-auto">
            ...
            <div class="card-body">
                ...
                <?= form_open('Admin/Pengiriman_A/update/' . $pengiriman->id_pengiriman) ?>
