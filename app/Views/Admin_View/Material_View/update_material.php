...
<?php
    ...
    $jumlah_material = [
        ...
        'id' => 'jumlah_material',
        'type' => 'number',
        'value' => $material->jumlah_material,
        'class' => 'form-control'
    ];
    ...
    <div class="row justify-content-center h-100">
        <div class="card w-50 my-auto">
            ...
            <div class="card-body">
                ...
                <?= form_open('Admin/Material_A/update/'.$material->id_material) ?>
                ...
                <div class="form-group mt-3">
                        <?= form_label("Harga Material", "jumlah_material") ?>
