    ...
    <div class="row justify-content-center h-100">
        <div class="card w-50 my-auto">
            ...
            <div class="card-body">
                ...
                <?= form_open('Admin/Vendor_A/update/' . $vendor->id_vendor) ?>

                <div class="form-group mt-3">
                    <?= form_label("Nama Vendor", "nama_vendor") ?>
                    <?= form_input($nama_vendor) ?>
                </div>

                <div class="form-group mt-3">
                    <?= form_label("Alamat Vendor", "alamat_vendor") ?>
                    <?= form_input($alamat_vendor) ?>
                </div>
